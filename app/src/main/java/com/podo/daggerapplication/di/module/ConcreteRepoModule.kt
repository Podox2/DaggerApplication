...
// бо не можливо заінджектити конструктор інтерфейсу (його не існує)
...
interface ConcreteBindRepoModule {
  ...
  // по суті ми байндимо тип IRepo з RepoImpl. коли граф шукає тип IRepo, то буде повертати RepoImpl
  @Binds
